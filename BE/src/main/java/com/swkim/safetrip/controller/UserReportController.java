...
@RestController
@RequestMapping("/v1/user-reports")
...
public class UserReportController {
    ...
    public ApiResult<Long> createReport(@AuthenticationPrincipal CustomUserDetails userDetails, @RequestPart @Valid UserReportSaveRequest request, @RequestPart(required = false) List<MultipartFile> images) {
